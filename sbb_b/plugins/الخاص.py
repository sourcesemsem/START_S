...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
     ...
     USER_BOT_NO_WARN = f""" **مـرحـبـا بـڪ {mention}  🦅.**\n\n**ممڪن اڪون ﻧـاي٘ـم اꪆ مشغوݪ 🦅.**\n\n**اتـࢪڪ ࢪسـاݪتڪ ۅانتظࢪ الࢪد عٓݪي٘ڪ 🦅.**\n\n**ݪاتـڪࢪࢪ الاࢪسـال انـتـظࢪ  🦅.**\n\n⤶ ❨ **لـديـڪ** {warns}/{totalwarns} **تحذيرات**❩\n\n[ . ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ - ᥴ𝗆𝖽 ᭡ .](https://t.me/FTTUTY) """
    else:
        USER_BOT_NO_WARN = f""" **مـرحـبـا بـڪ {mention}  🦅.**\n\n**ممڪن اڪون ﻧـاي٘ـم اꪆ مشغوݪ 🦅.**\n\n**اتـࢪڪ ࢪسـاݪتڪ ۅانتظࢪ الࢪد عٓݪي٘ڪ  🦅.**\n\n**ݪاتـڪࢪࢪ الاࢪسـال انـتـظࢪ  🦅.**\n\n⤶ ❨ **لـديـڪ** {warns}/{totalwarns} **تحذيرات**❩\n\n[ . ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ - ᥴ𝗆𝖽 ᭡ .](https://t.me/FTTUTY) """                   
...
async def approve_p_m(event):
    ...
    if len(approved_users) > 0:
        for user in approved_users:
            APPROVED_PMs += f"[ . ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ - ᥴ𝗆𝖽 ᭡ .](https://t.me/FTTUTY)\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
    else:
