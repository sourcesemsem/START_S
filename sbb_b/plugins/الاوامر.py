...
async def we(event):
    await event.reply(
        "⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯\n\n❃ `.لو خيروك`\n\n❃ `.كت`\n\n❃ `.نصيحه`\n\n❃ `.بوستات`\n\n❃ `.نكته`\n\n❃ `.اذكار`\n\n❃ `.اذكار الصباح`\n\n❃ `.صراحه`\n\n❃ `.كشف`\n\n❃ `.الذاتية تشغيل` امر حفظ الذاتية تلقائي\n\n❃ `.فيزا`\n\n❃ `.اوامر الرفع` \n\n❃ `.اوامر التجميع`\n\n◉`.بريد`  ل انشاء بريد وهمي\n\n◉ `.الوارد` لجلب رسايل البريد\n\n◉ `.شطرنج`  لعبة الشطرنج\n\n◉ `.ريفرسي`  اخر لعبة دارك نزلهاا 🤓\n\n◉ `.حجر ورقه مقص`\n\n◉ `.تيك توك` بالرد ع رابط تنزيل الفيديو\n\n◉ `.انستا`  بالرد عليه\n\n◉ `.تحميل فيديو` بالرد علي رابط من اليوتيوب\n\n◉ `.تحميل صوتي` بالرد علي رابط من اليوتيوب\n\n⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯"
    )
    await event.delete()
...
async def hi(event):
    await event.reply(
        "**⌔∮ قائـمة اوامر التسلية**:\n ⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯\n`.غبي`  `.القنابل`  `.بوت`   `.قتل`    `.طوبة`\n\n`.مربعات`   `.حلويات`     `.نار`     `.قمرات`\n\n`.افكر`    `.متت`    `.ضايج`    `.ساعة`\n\n`.مح`    `.قلب`     `.جيم`     `.الارض`\n\n`.قمر`      `.اقمار`     `.قمور `    `.نجمه`\n\n`.مكعبات`   `.مطر `     `.تفريغ`      `.فليم`\n\n`.احبك`    `.طائره`        `.شرطه `\n\n`.ملل`    `.قاتل`       `.عين`\n\n`.افكرر`      `.افعى`         `.وصلت`      `.مايكرو`\n\n`.ادفع`    `.قطار`      `.ادفع `\n\n`.شغل`   `.تحميل`     `.مربع`       `.دائره`\n\n`.انيم`    `.بشره`      `.قرد`      `.يد`\n\n`.العد التنازلي`        `.قلوب`\n\n`.فصخ + الكلام`\n\n`.طفي`     `.تهكير2`   `.تهكير3` .مدينه \n\n .خد .قول هلا .تف .هلو .مصه .اكل  .tf واحد\n\nٴ╼──────────────────╾\n • جميع الاوامر تستخدم بالضغط على الامر راح ينسخ وحده وارسله فقط\n\n ⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯",
        link_preview=False,
    )
    await event.delete()
...
async def hi(event):
    await event.reply(
        " قائمة اوامر بصمات وميمز الانمي\n ⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.انمي1` )\n- ( `.انمي2` )\n- ( `.انمي3` )\n- ( `.انمي4` )\n- ( `.انمي5` )\n- ( `.انمي6` )\n- ( `.انمي7` )\n- ( `.انمي8` )\n- ( `.انمي9` )\n- ( `.انمي10` )\n - ( `.اجمد كده` )\n- ( `.لماذا نحن هنا ` )\n- ( `.بووم` )\n- ( `.خلصانه` )\n- ( `.تعبان` )\n- ( `.يلاهوي` )\n- ( `.انا رمضان جانا` )\n- ( `.يا حلو` )\n- ( `.عاوزين نعملك بني ادم` )\n- ( `.ربنا نصرني ` )\n - ( `.اتكلم بادب ` )\n\n⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯"
    )        
    await event.delete()             
...
async def hi(event):
    await event.reply(
        "⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯\n\n**قائمة الاوامر الاضافية :**\n\n◉ `.حيوان`\n\n◉ `.الذاتية تشغيل`\n\n◉ `.سرعة النت`\n\n◉ `.توقيت`\n\n◉ `.حاسبة`\n\n◉ `.تاك 50` او 100 او 150 او 200\n\n◉ `.خط غامق`\n\n◉ `.خط الرمز`\n\n◉ `.البنك`\n\n◉ `.بحث` + المطلوب ل تنزيل صوت\n\n◉ `.فيديو` + المطلوب ل تنزيل فيديو\n\n◉ `.الالعاب`  لعرض الالعاب\n\n⌯╼═══❬ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ❭═══╾⌯"
    )        
    await event.delete()            
...
async def hi(event):
    await event.reply(
        "**[ ᥉᥆υᖇᥴᥱ ᥉ᥱꪔ᥆ ](https://t.me/FTTUTY)**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n• اوامر التحكم تتيح لمستخدم اخر ان يستخدم اوامر تنصيبك وهو غير منصب بوت سيمو حيث سيصبح متحكم في اوامر تنصيبك يرجى الانتباه من انه سيحصل على صلاحيات الاوامر وقد يسبب خطورة لك اذا كنت لا تثق في المستخدم الذي اضفته. \n\n\n`.التحكم` تفعيل/تعطيل\n• تستخدم هذه الميزة لتفعيل/لتعطيل خاصية التحكم بأوامر تنصيبك للمستخدمين الذين أضفتهم في قائمة المتحكمين\n\n`.المتحكمين`\n• لعرض المستخدمين الذين اضفتهم الى قائمة المستخدمين المتحكمين\n\n`.اضف متحكم`\n• بالرد على المستخدم لأضافته متحكم في تنصيب بوت سيمو الخاص بك\n\n`.ازالة متحكم`\n• بالرد على المستخدم لازالته من قائمة المتحكمين"
    ) 
    await event.delete()
